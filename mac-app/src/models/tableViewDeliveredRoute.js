...
function Routes(props){
    ...
    return (<tr key={props._data._id} className='customer-table-data-row'>
            ...
            <td key={props._data._id+"callins"} className='customer-table-data-cell'>{props._data.callins.length || 0}</td>
            <td key={props._data._id+"delivered"} className='customer-table-data-cell'>{props._data.delivered.length || 0}</td>
        </tr>);
}
