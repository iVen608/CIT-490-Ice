...
function CustomerForm(){
    ...
    return (<form className='customer-form' onSubmit={handleSubmit}>
        <input type="text" className='customer-form-text-input' name="name" placeholder='Customer Name' onChange={e => setData({...data, ["name"] : e.target.value})}/>
        <input type="text" className='customer-form-text-input' name="address" placeholder='Full Address'  onChange={e => setData({...data, ["address"] : e.target.value})}/>
        <select name="ice1" className='customer-form-select-input' onChange={e => setData({...data, ["ice1"] : e.target.value})}>
        ...
        <input type="number" className='customer-form-text-input' name="price1" placeholder='Ice Price'  onChange={e => setData({...data, ["price1"] : e.target.value})}/>
        ...
        <input type="number" className='customer-form-text-input' name="price2" placeholder='Ice Price'  onChange={e => setData({...data, ["price2"] : e.target.value})}/>
        ...
        <input type="checkbox" className='customer-form-check-input' name="delivery" onChange={e => setData({...data, ["delivery"] : e.target.checked})}/>
